...
import { Idea, Comment, Reply, CreateIdeaPayload, CreateCommentPayload, CreateReplyPayload } from "./types";
...
import { createComment, createIdea, createReply, getIdea, getIdeas } from "./queries";
