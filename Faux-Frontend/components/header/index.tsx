      ...
      <div className="bg-primary-background flex justify-between text-md p-4 box-content uppercase text-white  shadow-[white] shadow-xl " style={{borderBottom: "1px solid gray"}} >
        ...
        <div className="hidden lg:flex items-center space-x-8  ">
          ...
          <Link href={"/trade"} passHref>
            <div style={currentPage === "trade" ? activeButton : headerButton}>
              Trade
            </div>
          </Link>

          <Link href={"/ideas"} passHref>
            <div style={currentPage === "ideas" ? activeButton : headerButton}>
              Ideas
            </div>
          </Link>
...

        {
          ...
          <div className="hidden lg:flex space-x-6 items-center">
            <div className="p-2 box-content bg-white bg-opacity-20 rounded-lg">Balance: ${state.user?.balance}</div>
            <div className="p-2 box-content bg-white bg-opacity-20 rounded-lg">{state.user?.username}</div>
        ...
        <Modal 
          ...
          <div className="p-2 box-content bg-white bg-opacity-20 rounded-lg my-4 ">Balance: ${state.user?.balance}</div>
          <div className="p-2 box-content bg-white bg-opacity-20 rounded-lg">{state.user?.username}</div>
